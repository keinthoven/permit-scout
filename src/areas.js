...
// All recGovIds in this file have been verified to resolve to a real
// Recreation.gov page (last verified May 2026).
//
...
export const AREAS = [
...

  {
    ...
    notes:
      'JMW spans the eastern Sierra crest. Choose your permit by the side you enter from: Inyo (east) or Sierra (west). JMT thru-hikers use a separate Inyo NF lottery.',
    subLocations: [
      {
        id: 'jmw-inyo',
        name: 'Inyo NF entries (east side: Bishop, Mammoth, Lone Pine)',
        recGovId: '233262',
        type: 'permit',
        bookingWindow: {
          type: 'rolling',
      ...
      {
        id: 'jmw-sierra',
        name: 'Sierra NF entries (west side: Florence Lake, Edison, Courtright)',
        recGovId: '445858',
        type: 'permit',
        bookingWindow: {
          type: 'rolling',
...

  {
    ...
    notes:
      'Borders Yosemite NP to the south. Ansel Adams shares the Inyo and Sierra NF permit systems with John Muir Wilderness — pick your permit by entry side.',
    subLocations: [
      {
        id: 'ansel-adams-inyo',
        name: 'Inyo NF entries (Agnew Meadows, Mammoth Lakes, Reds Meadow)',
        recGovId: '233262',
        type: 'permit',
        bookingWindow: {
          type: 'rolling',
      ...
      {
        id: 'ansel-adams-sierra',
        name: 'Sierra NF entries (west side trailheads)',
        recGovId: '445858',
        type: 'permit',
        bookingWindow: {
          type: 'rolling',
...

  {
    ...
    state: 'CA',
    region: 'Sierra Nevada',
    managing: 'Humboldt-Toiyabe National Forest',
    permitType: 'quota',
    season: { start: 'June 15', end: 'Oct 15' },
    tags: ['sierra', 'overnight', 'popular'],
    notes:
      'Quieter neighbor to Yosemite. Bridgeport Ranger District trailheads (Twin Lakes, Green Creek, Virginia Lakes) require a Rec.gov permit; some lower-traffic entries remain self-issue.',
    subLocations: [
      {
        id: 'hoover-permit',
        name: 'Bridgeport Ranger District Permit',
        recGovId: '445856',
        type: 'permit',
        bookingWindow: {
          type: 'rolling',
...

  {
    ...
    notes:
      'No quota, no advance permit required — self-issue at the trailhead. One of the last permit-free wildernesses in the northern Sierra.',
    subLocations: [
      {
        id: 'emigrant-walk-up',
        name: 'All trailheads',
...

  {
    ...
    notes:
      'All four hike-in campgrounds (Coast, Sky, Glen, Wildcat) and the Tomales Bay boat-in sites are booked through one Rec.gov listing. Most sites release on a 3-month rolling window; some sites use a 14-day window.',
    subLocations: [
      {
        id: 'pt-reyes-all',
        name: 'All Campgrounds (Coast, Sky, Glen, Wildcat, Tomales Bay)',
        recGovId: '233359',
        type: 'campground',
        bookingWindow: {
          type: 'rolling',
          ...
          timezone: 'America/Los_Angeles',
          notes:
            'Most sites release 3 months ahead; some sites use a 14-day window. See Rec.gov for site-specific details.',
        },
      },
    ],
  },
  ...
  {
    id: 'central-cascades',
    name: 'Central Oregon Cascades (Three Sisters, Mt. Jefferson, etc.)',
    state: 'OR',
    region: 'Pacific Northwest',
    ...
    notes:
      'One Rec.gov permit covers Three Sisters, Mt. Jefferson, Mount Washington, Diamond Peak, and Waldo Lake Wildernesses. Two-stage release: bulk for the season + 7-day rolling for cancellations.',
    subLocations: [
      {
        id: 'central-cascades-overnight',
        name: 'Overnight Permit (all five wildernesses)',
        recGovId: '4675311',
        type: 'permit',
        bookingWindow: {
...

  {
    ...
    notes:
      'Overnight permits required Jun 1–Sep 15. Free self-issue permits available Mon–Thu at most trailheads.',
    subLocations: [
      {
        id: 'indian-peaks-overnight',
        name: 'Overnight Permit (full season in advance)',
        recGovId: '4675318',
        type: 'permit',
        bookingWindow: {
          type: 'seasonal-release',
          releaseDate: 'Early March',
          releaseTime: '08:00',
          timezone: 'America/Denver',
          coverage: 'June 1 – September 15 trip dates',
          notes:
            'Full season released at once. Cancellations and unsold permits available 3 days in advance via separate Rec.gov listing.',
        },
      },
    ],
  },
...

  {
    ...
    notes:
      'NPS runs the lottery directly via Recreation.gov. Rolling 4-month availability after the lottery.',
    subLocations: [
      {
        ...
        bookingWindow: {
          ...
          notes:
            'For a May 2026 trip, apply Jan 1–~Jan 21, 2026. Bright Angel, South Kaibab, and North Kaibab corridors most competitive.',
        },
      },
    ],
  },
    ...
    subLocations: [
      {
        ...
        bookingWindow: {
          ...
          notes:
            'For a July trip, apply April 1–25. Cancellation/leftover permits available rolling 1 month ahead.',
        },
      },
    ],
  },
